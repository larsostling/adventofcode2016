...
public class DayTwentyThree implements Puzzle {
    @Override
    public String solvePartOne(String input) {
        return handleInstructions(new Computer(7, 0, 0, 0), input);
    }

    @Override
    public String solvePartTwo(String input) {
        return handleInstructions(new Computer(12, 0, 0, 0), input);
    }
